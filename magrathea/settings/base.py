# flake8: noqa
"""
Django settings for magrathea project.
...
DJANGO_ROOT = root.path('magrathea')
...
WSGI_APPLICATION = 'magrathea.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///magrathea'),
}
